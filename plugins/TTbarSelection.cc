...
// if(massTT >= min_mass && massTT<=max_mass){
// 	float pt1 = px1 / cos(phi1);
// 	float pt2 = px2 / cos(phi2);
//     std::cout<<"First Leg = "<<mm_pdgId1<<"\t"<<m_pdgId1<<"\t"<<pdgId1<<"\tSecond leg = "<<mm_pdgId2<<"\t"<<m_pdgId2<<"\t"<<pdgId2<<" ....."<<massTT<<"\tpt1 = "<<pt1<<"\tpt2 = "<<pt2<<std::endl;
//     std::cout<<",,,,,"<<massTT<<std::endl;
// 	count++;
// 	}
