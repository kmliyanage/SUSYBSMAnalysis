...
void Zprime_Invariant_mass(){
    ...
    double dy[8]={0},ttbar[8]={0},tW[8]={0},Wantitop[8]={0},WW[8]={0},WZ[8]={0},ZZ[8]={0},Zjets[8]={0},Wjets[8]={0},Zprime[8]={0};
    ...
    const double LUMINOSITY = 42081.34641; //in pb
    
    float weight[mc] = {0};
    float weight_BB[mc] = {0};
    float weight_BE[mc] = {0};
            ...
            if(
               ...
               //fabs(lep_tk_dz[0]) < 1.0 && fabs(lep_tk_dz[1]) < 1.0
                ...
                if(j==10){ //for ttbar
                    ...
                    if(vertex_m>=60.0 && vertex_m<120.0) ttbar[1]=ttbar[1]+weight[j];
                    if(vertex_m>=120.0 && vertex_m<400.0) ttbar[2]=ttbar[2]+weight[j];
                    if(vertex_m>=400.0 && vertex_m<600.0) ttbar[3]=ttbar[3]+weight[j];
                    if(vertex_m>=600.0 && vertex_m<900.0) ttbar[4]=ttbar[4]+weight[j];
                    if(vertex_m>=900.0 && vertex_m<1300.0) ttbar[5]=ttbar[5]+weight[j];
                    if(vertex_m>=1300.0 && vertex_m<1800.0) ttbar[6]=ttbar[6]+weight[j];
                    if(vertex_m>=1800.0) ttbar[7]=ttbar[7]+weight[j];
                    ...
                    if(vertex_m>=60.0 && vertex_m<120.0) tW[1]=tW[1]+weight[j];
                    if(vertex_m>=120.0 && vertex_m<400.0) tW[2]=tW[2]+weight[j];
                    if(vertex_m>=400.0 && vertex_m<600.0) tW[3]=tW[3]+weight[j];
                    if(vertex_m>=600.0 && vertex_m<900.0) tW[4]=tW[4]+weight[j];
                    if(vertex_m>=900.0 && vertex_m<1300.0) tW[5]=tW[5]+weight[j];
                    if(vertex_m>=1300.0 && vertex_m<1800.0) tW[6]=tW[6]+weight[j];
                    if(vertex_m>=1800.0) tW[7]=tW[7]+weight[j];
                }
                    ...
                    if(vertex_m>=60.0 && vertex_m<120.0) Wantitop[1]=Wantitop[1]+weight[j];
                    if(vertex_m>=120.0 && vertex_m<400.0) Wantitop[2]=Wantitop[2]+weight[j];
                    if(vertex_m>=400.0 && vertex_m<600.0) Wantitop[3]=Wantitop[3]+weight[j];
                    if(vertex_m>=600.0 && vertex_m<900.0) Wantitop[4]=Wantitop[4]+weight[j];
                    if(vertex_m>=900.0 && vertex_m<1300.0) Wantitop[5]=Wantitop[5]+weight[j];
                    if(vertex_m>=1300.0 && vertex_m<1800.0) Wantitop[6]=Wantitop[6]+weight[j];
                    if(vertex_m>=1800.0) Wantitop[7]=Wantitop[7]+weight[j];
                }
                    ...
                    if(vertex_m>=60.0 && vertex_m<120.0) WW[1]=WW[1]+weight[j];
                    if(vertex_m>=120.0 && vertex_m<400.0) WW[2]=WW[2]+weight[j];
                    if(vertex_m>=400.0 && vertex_m<600.0) WW[3]=WW[3]+weight[j];
                    if(vertex_m>=600.0 && vertex_m<900.0) WW[4]=WW[4]+weight[j];
                    if(vertex_m>=900.0 && vertex_m<1300.0) WW[5]=WW[5]+weight[j];
                    if(vertex_m>=1300.0 && vertex_m<1800.0) WW[6]=WW[6]+weight[j];
                    if(vertex_m>=1800.0) WW[7]=WW[7]+weight[j];
                }
                    ...
                    if(vertex_m>=60.0 && vertex_m<120.0) WZ[1]=WZ[1]+weight[j];
                    if(vertex_m>=120.0 && vertex_m<400.0) WZ[2]=WZ[2]+weight[j];
                    if(vertex_m>=400.0 && vertex_m<600.0) WZ[3]=WZ[3]+weight[j];
                    if(vertex_m>=600.0 && vertex_m<900.0) WZ[4]=WZ[4]+weight[j];
                    if(vertex_m>=900.0 && vertex_m<1300.0) WZ[5]=WZ[5]+weight[j];
                    if(vertex_m>=1300.0 && vertex_m<1800.0) WZ[6]=WZ[6]+weight[j];
                    if(vertex_m>=1800.0) WZ[7]=WZ[7]+weight[j];
                }
                    ...
                    if(vertex_m>=60.0 && vertex_m<120.0) ZZ[1]=ZZ[1]+weight[j];
                    if(vertex_m>=120.0 && vertex_m<400.0) ZZ[2]=ZZ[2]+weight[j];
                    if(vertex_m>=400.0 && vertex_m<600.0) ZZ[3]=ZZ[3]+weight[j];
                    if(vertex_m>=600.0 && vertex_m<900.0) ZZ[4]=ZZ[4]+weight[j];
                    if(vertex_m>=900.0 && vertex_m<1300.0) ZZ[5]=ZZ[5]+weight[j];
                    if(vertex_m>=1300.0 && vertex_m<1800.0) ZZ[6]=ZZ[6]+weight[j];
                    if(vertex_m>=1800.0) ZZ[7]=ZZ[7]+weight[j];
                }
                    ...
                    if(vertex_m>=60.0 && vertex_m<120.0) Wjets[1]=Wjets[1]+weight[j];
                    if(vertex_m>=120.0 && vertex_m<400.0) Wjets[2]=Wjets[2]+weight[j];
                    if(vertex_m>=400.0 && vertex_m<600.0) Wjets[3]=Wjets[3]+weight[j];
                    if(vertex_m>=600.0 && vertex_m<900.0) Wjets[4]=Wjets[4]+weight[j];
                    if(vertex_m>=900.0 && vertex_m<1300.0) Wjets[5]=Wjets[5]+weight[j];
                    if(vertex_m>=1300.0 && vertex_m<1800.0) Wjets[6]=Wjets[6]+weight[j];
                    if(vertex_m>=1800.0) Wjets[7]=Wjets[7]+weight[j];
                }
                    ...
                    if(vertex_m>=60.0 && vertex_m<120.0) Zjets[1]=Zjets[1]+weight[j];
                    if(vertex_m>=120.0 && vertex_m<400.0) Zjets[2]=Zjets[2]+weight[j];
                    if(vertex_m>=400.0 && vertex_m<600.0) Zjets[3]=Zjets[3]+weight[j];
                    if(vertex_m>=600.0 && vertex_m<900.0) Zjets[4]=Zjets[4]+weight[j];
                    if(vertex_m>=900.0 && vertex_m<1300.0) Zjets[5]=Zjets[5]+weight[j];
                    if(vertex_m>=1300.0 && vertex_m<1800.0) Zjets[6]=Zjets[6]+weight[j];
                    if(vertex_m>=1800.0) Zjets[7]=Zjets[7]+weight[j];
                }
                    ...
                    if(vertex_m>=60.0) ttbar[0] = ttbar[0]+weight[j];
                    if(vertex_m>=60.0 && vertex_m<120.0) Zprime[1]=Zprime[1]+weight[j];
                    if(vertex_m>=120.0 && vertex_m<400.0) Zprime[2]=Zprime[2]+weight[j];
                    if(vertex_m>=400.0 && vertex_m<600.0) Zprime[3]=Zprime[3]+weight[j];
                    if(vertex_m>=600.0 && vertex_m<900.0) Zprime[4]=Zprime[4]+weight[j];
                    if(vertex_m>=900.0 && vertex_m<1300.0) Zprime[5]=Zprime[5]+weight[j];
                    if(vertex_m>=1300.0 && vertex_m<1800.0) Zprime[6]=Zprime[6]+weight[j];
                    if(vertex_m>=1800.0) Zprime[7]=Zprime[7]+weight[j];
                }
                    ...
                    if(vertex_m>=60.0 && vertex_m<120.0) dy[1]=dy[1]+weight[j];
                    if(vertex_m>=120.0 && vertex_m<400.0) dy[2]=dy[2]+weight[j];
                    if(vertex_m>=400.0 && vertex_m<600.0) dy[3]=dy[3]+weight[j];
                    if(vertex_m>=600.0 && vertex_m<900.0) dy[4]=dy[4]+weight[j];
                    if(vertex_m>=900.0 && vertex_m<1300.0) dy[5]=dy[5]+weight[j];
                    if(vertex_m>=1300.0 && vertex_m<1800.0) dy[6]=dy[6]+weight[j];
                    if(vertex_m>=1800.0) dy[7]=dy[7]+weight[j];
...
void DrawPlot(TH1F* DY, TH1F* ttbar, TH1F* tW, TH1F* Wantitop, TH1F* WW, TH1F* WZ, TH1F* ZZ, TH1F* Wjets,  /*Th1F* qcd, */TH1F* Zjets, TH1F* Zprime, TH1F* DATA, THStack* DATA_MC, TString title, TString name, bool logx){
    ...
    TText *t2 = tText2->AddText("CMS 2017 Data 42.1 fb^{-1} (13TeV)");
